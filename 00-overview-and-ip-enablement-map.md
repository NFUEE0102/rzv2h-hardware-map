...
| `enable_overlay_audio_codec` | commented out | `rzv2h-rdk-1.0-audio-codec.dtbo` | External audio codec. **Enabling it disables micro-HDMI audio** (see the g3 file) |
